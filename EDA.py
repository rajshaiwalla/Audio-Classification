...
#ESTIMATING ENVELOPE OF A SIGNAL
...
##REMOVING MEANS OF LENGHTH ACCORDING TO EACH CLASS
...
##CREATING PLOT FOR CLASS DISTRIBUTION
fig, ax = plt.subplots()
...
#STORE PREPROCEESED AND DOWNSAMPLED DATA IN CLEAN FOLDER
